...
const DEFAULT_SETTINGS = {
  ...
  showClock: true,
  verticalTabs: false,
  verticalTabsExpandOnHover: false,
  wallpaper: 'redwoods',
...
class SettingsManager {
  ...
  validateSetting(key, value) {
    const validators = {
      ...
      verticalTabsExpandOnHover: (v) => typeof v === 'boolean',
  ...
  applySettings() {
    ...
    this.applySettingChange('verticalTabsExpandOnHover', this.settings.verticalTabsExpandOnHover);
  ...
  applySettingChange(key, value) {
    try {
      ...
      } else if (key === 'verticalTabsExpandOnHover') {
        // Notify windows of vertical tabs expand on hover setting change
        windows.forEach(window => {
          if (window && !window.isDestroyed()) {
            window.webContents.send('vertical-tabs-expand-on-hover-changed', value);
          }
        });
